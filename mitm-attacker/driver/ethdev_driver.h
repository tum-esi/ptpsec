...
typedef int (*eth_timesync_get_offset_to_pps)(struct rte_eth_dev *dev,
				      int64_t *offset, uint64_t *clock_nsec);
// end PTPsec
/** @internal Function used to get time from the device clock. */
typedef int (*eth_timesync_write_time)(struct rte_eth_dev *dev,
				       const struct timespec *timestamp);
// PTPsec
typedef int (*eth_timesync_adj_inc_val)(struct rte_eth_dev *dev,
				       uint32_t inc_val);

typedef int (*eth_timesync_adj_val)(struct rte_eth_dev *dev,
				       int64_t delta);
// end PTPsec
...
struct eth_dev_ops {
	...
	// PTPsec
	eth_timesync_adj_inc_val   timesync_adj_inc_val;
	eth_timesync_adj_val   timesync_adj_val;
	eth_timesync_get_offset_to_pps   timesync_get_offset_to_pps;
	// end PTPsec
