...
// PTPsec
int rte_eth_timesync_read_time(uint16_t port_id, struct timespec *time, int64_t *correction);
int rte_eth_timesync_get_offset_to_pps(uint16_t port_id, int64_t *offset, uint64_t *clock_nsec);
int rte_eth_timesync_adj_inc_val(uint16_t port_id, uint32_t inc_val);
int rte_eth_timesync_adj_val(uint16_t port_id, int64_t delta);
// end PTPsec
