...
// PTPsec
rte_eth_timesync_read_time(uint16_t port_id, struct timespec *timestamp, int64_t *correction)
// end PTPsec
{
	struct rte_eth_dev *dev;
	int ret;
...
// PTPsec
int
rte_eth_timesync_adj_inc_val(uint16_t port_id, uint32_t inc_val)
{
	struct rte_eth_dev *dev;
	int ret;
	...
	if (*dev->dev_ops->timesync_adj_inc_val == NULL)
		return -ENOTSUP;
	ret = eth_err(port_id, (*dev->dev_ops->timesync_adj_inc_val)(dev,
								inc_val));

	// rte_eth_trace_timesync_adj_inc_val(port_id, inc_val, ret);
...
int
rte_eth_timesync_adj_val(uint16_t port_id, int64_t delta)
{
	struct rte_eth_dev *dev;
	int ret;
	...
	if (*dev->dev_ops->timesync_adj_val == NULL)
		return -ENOTSUP;
	ret = eth_err(port_id, (*dev->dev_ops->timesync_adj_val)(dev,
								delta));

	// rte_eth_trace_timesync_adj_val(port_id, inc_val, ret);
...
int
rte_eth_timesync_get_offset_to_pps(uint16_t port_id, int64_t *offset, uint64_t *clock_nsec)
{
	struct rte_eth_dev *dev;
	int ret;
	...
	if (*dev->dev_ops->timesync_get_offset_to_pps == NULL)
		return -ENOTSUP;
	ret = eth_err(port_id, (*dev->dev_ops->timesync_get_offset_to_pps)(dev,
								offset, clock_nsec));

	// rte_eth_trace_timesync_get_offset_to_pps(port_id, offset, ret);
